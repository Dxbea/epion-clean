...
export const MODEL_DETAILS = {
    [AI_MODELS.STANDARD]: { label: 'Web', description: 'Recherche web standard', tier: 'free', trustScore: 80 },
    [AI_MODELS.ADVANCED]: { label: 'Web Deep', description: 'Recherche web approfondie', tier: 'premium', trustScore: 95 },
