...
import { router as adminEditorialRouter } from './routes/admin-editorial.js';
import { router as adminEditorialOpsRouter } from './routes/admin-editorial-ops.js';
...
app.use('/api', adminEditorialOpsRouter);
