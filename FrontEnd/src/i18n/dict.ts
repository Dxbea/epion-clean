...
export const DICT = {
  en: {
    ...
    home_why_1_desc: "Information floods in from every side—fast, messy, and often misleading. Epion cuts through the noise, giving you clear, vetted insights you can rely on.",
    home_why_2_title: "Your Dynamic, AI-Driven Newsroom",
    home_why_2_desc: "More than a reader and more than a chatbot. Epion combines editorial precision with on-demand AI, so you control how deep you go—whether it’s a quick overview or an in-depth breakdown.",
    home_why_3_title: "Instant Verification, Zero Spin",
    home_why_3_desc: "See something questionable? A headline, a quote, a claim? One click in Epion and our AI cross-checks top sources, delivering a direct answer—no agendas, just clarity.",
    home_why_4_title: "Insights That Spark Conversation",
    home_why_4_desc: "Read a story. Unpack complex topics. Share your perspective. Epion equips you with contextual background, key data points, and a space to discuss what truly matters.",
  ...
  fr: {
    ...
    home_why_1_desc: "L'information afflue de partout — rapide, confuse et souvent trompeuse. Epion filtre le bruit pour vous offrir des éclairages clairs et vérifiés.",
    home_why_2_title: "Votre rédaction dynamique pilotée par l'IA",
    home_why_2_desc: "Plus qu'un lecteur et plus qu'un chatbot. Epion combine précision éditoriale et IA à la demande, vous contrôlez la profondeur — d'un simple aperçu à une analyse détaillée.",
    home_why_3_title: "Vérification instantanée, sans parti pris",
    home_why_3_desc: "Un doute sur un titre, une citation, une affirmation ? En un clic, notre IA recoupe les meilleures sources pour une réponse directe — sans agenda, juste de la clarté.",
    home_why_4_title: "Des éclairages qui suscitent le débat",
    home_why_4_desc: "Lisez, décortiquez, partagez votre avis. Epion vous donne le contexte, les points clés et un espace pour discuter de ce qui compte vraiment.",
