...
export const DICT = {
  en: {
    ...
    home_informed_title: "Being informed has never been this easy",
    home_informed_desc: "on epion read and generate information with the community",
    home_read_articles: "read articles",
    home_ai_chat_title: "Forget traditionals ai chat",
    home_ai_chat_desc: "on epion access to reliable fact check and deep analysis on every subject.",
    home_open_ai_chat: "open ai chat",
    ...
    home_why_1_title: "Reclaim Your Trust in News",
    home_why_1_desc: "Information is everywhere, fast, noisy, and often misleading. Epion filters the chaos to bring you clear, well-sourced insights, completely free from the clutter.",
    home_why_2_title: "Your Dynamic, AI-Powered Newsroom",
    home_why_2_desc: "More than just a feed. Epion combines editorial rigor with generative AI to match your curiosity. You control the depth of your reading: from a quick three-point overview to a comprehensive, on-demand analysis.",
    home_why_3_title: "Radical transparency as our compass",
    home_why_3_desc: "Have a doubt about a claim? In one click, our AI cross-checks top sources and delivers a verdict. Most importantly, we open the hood: Epion shows you exactly which sources were used and how your trust score was calculated. No hidden agendas, no black boxes.",
    home_why_4_title: "The first social network for critical thinking",
    home_why_4_desc: "The news doesn't stop when you finish reading. Join a community of curious minds in a social space built for constructive debate. Share your insights, discuss verified facts, and build collective intelligence, far from the toxicity of traditional platforms.",
    home_why_5_title: "Check. Learn. Talk.",
    home_why_5_desc: "Fast verification. Smarter understanding. Meaningful dialogue. Epion: where information meets intelligence.",
    home_feed_title: "Article feed",
    home_feed_desc: "Discovery of fact-checked news, consultation of varied articles and sharing with the community. Find the essential in a blink.",
    home_creation_title: "Article creation",
    home_creation_desc: "Generation via a simple prompt for oneself or for publication. Become an actor of information with the help of Epion.",
    home_chat_title: "AI Chat",
    home_chat_desc: "Conversation and dynamic investigation mode with AI. Ask your questions, demand sources and understand subjects in depth.",
    home_transparency_title: "Absolute Transparency",
    home_transparency_desc: "Explanation of the global score, AI fact-checks and guaranteed access to sources. The heart of Epion 2.0 at the service of integrity.",
  ...
  fr: {
    ...
    home_informed_title: "S'informer n'a jamais été aussi simple",
    home_informed_desc: "sur epion, lisez et générez de l'information avec la communauté",
    home_read_articles: "lire les articles",
    home_ai_chat_title: "Oubliez les chats IA traditionnels",
    home_ai_chat_desc: "sur epion, accédez à des vérifications de faits fiables et des analyses approfondies sur tous les sujets.",
    home_open_ai_chat: "ouvrir le chat IA",
    ...
    home_why_1_title: "Retrouvez confiance en l'information",
    home_why_1_desc: "L'actualité afflue de partout, rapide, bruyante et souvent trompeuse. Epion filtre ce chaos pour vous offrir des éclairages clairs, sourcés et débarrassés du superflu.",
    home_why_2_title: "Votre média dynamique, amélioré par l'IA",
    home_why_2_desc: "Plus qu'un simple flux d'articles. Epion combine rigueur éditoriale et IA générative pour s'adapter à votre curiosité. Vous contrôlez la profondeur de lecture : d'un aperçu en trois points à une analyse détaillée rédigée à la demande.",
    home_why_3_title: "La transparence radicale comme boussole",
    home_why_3_desc: "Un doute sur une affirmation ? En un clic, notre IA recoupe les meilleures sources et vous livre son verdict. Surtout, nous ouvrons le capot : Epion vous montre exactement les sources utilisées et comment le score de confiance a été calculé. Pas d'agenda caché, pas de boîte noire.",
    home_why_4_title: "Le premier réseau social de l'esprit critique",
    home_why_4_desc: "L'information ne s'arrête pas à la lecture. Rejoignez une communauté d'esprits curieux au sein d'un véritable réseau social pensé pour le débat constructif. Partagez vos analyses, commentez sur la base de faits vérifiés et construisez l'intelligence collective, loin de la toxicité des réseaux traditionnels.",
    home_why_5_title: "Vérifie. Comprends. Discute.",
    home_why_5_desc: "Vérification rapide. Meilleure compréhension. Dialogue constructif. Epion : là où l'information rencontre l'intelligence.",
    home_feed_title: "Flux d'articles",
    home_feed_desc: "Découverte des news fact-checkées, consultation d'articles variés et partage avec la communauté. Retrouvez l'essentiel en un clin d'œil.",
    home_creation_title: "Création d'articles",
    home_creation_desc: "Génération via un simple prompt pour soi ou pour publication. Devenez acteur de l'information avec l'aide d'Epion.",
    home_chat_title: "Chat IA",
    home_chat_desc: "Mode conversation et investigation dynamique avec l'IA. Posez vos questions, exigez des sources et comprenez les sujets en profondeur.",
    home_transparency_title: "Transparence Absolue",
    home_transparency_desc: "Explication du score global, des vérifications factuelles de l'IA et de l'accès garanti aux sources. Le cœur Epion 2.0 au service de l'intégrité.",
