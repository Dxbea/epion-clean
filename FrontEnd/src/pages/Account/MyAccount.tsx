...
import AccountChangeEmailBox from '@/components/account/AccountChangeEmailBox'; // <-- AJOUTER CET IMPORT
    ...
    <PageContainer className="py-10">
      ...
      <header className="mb-6">
        ...
        <div className="mt-3 flex items-center justify-end">
          <Link to="/settings" className="rounded-xl border border-surface-200 px-3 py-2 text-sm hover:bg-surface-100 dark:border-neutral-800 dark:hover:bg-neutral-900">
            {t('settings_title')}
          </Link>
        </div>
      </header>
