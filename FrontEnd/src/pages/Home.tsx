...
export default function Home(): JSX.Element {
  ...
  return (
    <div className="min-h-screen space-y-16 sm:space-y-24">
        ...
        <div className="mt-8">
          {[
            ...
            <div key={idx} className={`relative mb-10 w-full lg:w-1/2 ${idx % 2 === 1 ? 'lg:ml-auto' : ''}`}>
              <H3 as="div" className="mb-2 text-xl font-bold text-gray-900 dark:text-white">
                <span style={getGradientTextStyle()} className="mr-2">
                  {item.title.split('.')[0]}.
                </span>
      ...
      {/* EXAMPLE — full text with vivid clean design */}
      <Section id="example" className="pb-16">
        <div className="mb-6 flex items-center justify-center gap-4">
          <H3 as="div" className="text-center">Example of a conversation with Epion</H3>
          <div className="hidden sm:block w-[30vw] h-[2px] rounded-md" style={{ background: getEpionBrandGradient() }} />
        </div>
        <div className="mx-auto max-w-[90%] md:max-w-[80%]">
          <div className="rounded-xl bg-black p-4 sm:p-6 md:p-8 text-white shadow-lg">
            {/* Question */}
            <div className="mb-6 ml-[20%] sm:ml-[30%] md:ml-[40%] max-w-[90%] sm:max-w-[80%] md:max-w-[60%] rounded-lg bg-gray-900 border border-gray-800 px-4 py-3 text-sm sm:text-base md:text-sm text-white">
              J'ai entendu dire que Mistral AI pourrait être racheté notamment par Apple. Est-ce vrai ?
            </div>
            {/* Answer (clean) */}
            <div className="rounded-xl p-4 sm:p-6 md:p-8 bg-white text-gray-900">
              <h4 className="text-base sm:text-lg md:text-base font-bold">1. Rumeurs et spéculations</h4>
              ...
              <h4 className="mt-4 text-base sm:text-lg md:text-base font-bold">2. La position officielle de Mistral</h4>
              <ul className="list-disc pl-6 space-y-1 text-sm sm:text-base md:text-sm">
              ...
              <h4 className="mt-4 text-base sm:text-lg md:text-base font-bold">3. Freins géopolitiques et réglementaires</h4>
              <ul className="list-disc pl-6 space-y-1 text-sm sm:text-base md:text-sm">
              ...
              <h4 className="mt-4 text-base sm:text-lg md:text-base font-bold">4. Évaluation du scénario probable</h4>
              <ul className="list-disc pl-6 space-y-1 text-sm sm:text-base md:text-sm">
              ...
              <h4 className="mt-4 text-base sm:text-lg md:text-base font-bold" style={{ background: getEpionBrandGradient(), WebkitBackgroundClip: 'text', backgroundClip: 'text', color: 'transparent' }}>Conclusion Epion</h4>
