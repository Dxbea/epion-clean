...
export function Switch({ checked, onCheckedChange, disabled = false }: SwitchProps) {
    return (
        ...
        focus-visible:ring-epion-turquoise focus-visible:ring-offset-2 focus-visible:ring-offset-white
        dark:focus-visible:ring-offset-neutral-950
        ${checked ? 'bg-epion-turquoise' : 'bg-gray-200 dark:bg-neutral-700'}
